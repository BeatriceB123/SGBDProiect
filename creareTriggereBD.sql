...
/ 
--TODO: testare tot
select * from bank_account where id_account = 1;
select * from bank_account where id_account = 300003;
select * from transaction_history where id_transaction=2000003;
select * from exchange_rate where id_rate=1;
insert into transaction_history values (2000009, 1, 1, 300003, 300003, 1, 'Withdraw', sysdate, '09:34', 5000, NULL, NULL);