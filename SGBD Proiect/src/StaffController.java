...
public class StaffController {
    ...
    public void salaryIncrease(int id, int raiseValue) throws SQLException {
        Connection con = Database.getConnection();
    ...
    public void employeeOfTheMonth(int monthNr, int yearNr, int raiseValue) throws SQLException {
        Connection con = Database.getConnection();
    ...
    public void findById(int id) throws SQLException {
        ...
        try (Statement stmt = con.createStatement();
            ...
            rs.next();
            System.out.println("Staff Id: " + rs.getString(1) + " bank Id: " + rs.getString(2) + ", first name: " + rs.getString(3) + ", last name: " +
                    rs.getString(4) + ", city: " + rs.getString(5) + ", email: " + rs.getString(6) +
                    ", phone number: " + rs.getString(7) + ", date of birth: " + rs.getString(8)  + " job position: " + rs.getString(9) +
                    " salary: " + rs.getString(10) + ". It has been created at: " + rs.getString(11) +
